...
sealed class DetailedSimpleUIAction {

    sealed class ChangeSpinnerSelection: DetailedSimpleUIAction() {
    ...
    class ChangeType3SpinnerSelection(val position: Int): DetailedSimpleUIAction()
