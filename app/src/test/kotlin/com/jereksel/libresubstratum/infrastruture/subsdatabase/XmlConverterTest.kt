...
class XmlConverterTest: FunSpec() {
    ...
    init {
        ...
        test("Fields are mapped") {
            ...
            val themes = XmlConverter.convert(xml)
            ...
            assertThat(theme.pricing).isEqualTo(Pricing.PAID)
            assertThat(theme.backgroundImage).isEqualTo("https://raw.githubusercontent.com/substratum/database/master/images/beltz.png")
            assertThat(theme.image).isEqualTo("http://lh3.googleusercontent.com/jMWFY93hzT-Wrwo06Y0uCOXwGCy8D0cd2uDBR4MkGswOj0BGatEDBRmJIOnN3TjfTjg=w300-rw")
        }
