...
class RoomThemeInfoDBTest: BaseRobolectricTest() {
    ...
    fun `Type1 theme pack test`() {
        val type1a = Type1Data(listOf(Type1Extension("yellow", true), Type1Extension("blue", false)), "a")
        val type1b = Type1Data(listOf(Type1Extension("red", true), Type1Extension("pink", false)), "b")
        val type1c = Type1Data(listOf(Type1Extension("white", true), Type1Extension("black", false)), "c")
    ...
    fun `Type2 theme pack test`() {
        val type2a = Type2Data(listOf(Type2Extension("yellow", true), Type2Extension("blue", false)))
        val type2b = Type2Data(listOf(Type2Extension("red", true), Type2Extension("pink", false)))
    ...
    fun `Type3 theme pack test`() {
        val type3 = Type3Data(listOf(Type3Extension("yellow", true), Type3Extension("blue", false)))
